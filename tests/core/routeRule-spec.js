...
describe('core/routeRule', function () {
    ...
    it('construct case', function () {
        ...
        expect(routeRule.pattern.regex).toEqual(/^posts\/([a-z]+)\/(\d+)$/g);
    ...
    it('construct case 2', function () {
        ...
        expect(routeRule.pattern.regex).toEqual(/^posts\/([a-z]+)$/g);
    ...
    it('construct case 6', function () {
        ...
        expect(routeRule.pattern.regex).toEqual(/^posts\/(create|update|delete)\/(\d+)$/g);
    ...
    it('toRegex', function () {
        ...
        expect(obj.regex).toEqual(/abc\/cd/g);
    });
